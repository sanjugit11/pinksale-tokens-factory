...
import "contracts/libs/BabyTokenDividendTracker.sol";
...
contract BabyToken is  Ownable, BaseToken,Initializable ,IERC20{
    ...
    // }
     ...
     function setNameSymbol(string memory name_, string memory symbol_) public {
        _name = name_;
        _symbol = symbol_;
    }
    /**
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            transferFrom(from, address(this), fees);
        }
